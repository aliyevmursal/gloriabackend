                    ...
                    Box::make([
                        ...
                        Tabs::make([
                            ...
                            Tab::make('RU', [
                                ...
                                Markdown::make('Content (RU)', 'description_ru'),
                                Text::make('Meta Title (RU)', 'meta_title_ru'),
                                Text::make('Meta Description (RU)', 'meta_description_ru'),
                                Text::make('Meta Keywords (RU)', 'meta_keywords_ru'),
                                Text::make('OG Title (RU)', 'og_title_ru'),
                                Text::make('OG Description (RU)', 'og_description_ru'),
                            ]),
                        ]),
                    ])
                ])->columnSpan(8),
