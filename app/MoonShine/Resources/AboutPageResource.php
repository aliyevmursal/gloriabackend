                ...
                Column::make([
                    Box::make([
                        ...
                        Tabs::make([
                            ...
                            Tab::make('RU', [
                                Markdown::make('Description (RU)', 'description_ru'),
                                Text::make('Quality Title (RU)', 'quality_title_ru'),
                                Textarea::make('Quality Description (RU)', 'quality_description_ru'),
                                Text::make('Individual Approach Title (RU)', 'individual_approach_title_ru'),
                                Textarea::make('Individual Approach Description (RU)', 'individual_approach_description_ru'),
                                Text::make('Worldwide Shipping Title (RU)', 'worldwide_shipping_title_ru'),
                                Textarea::make('Worldwide Shipping Description (RU)', 'worldwide_shipping_description_ru'),
